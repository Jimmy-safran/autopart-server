...
class LineAType
{
     ...
     *
     * 3. This number **must not** be used as a reference to the line in the availability request.
     *
     * @var int $number
     */
    private $number = null;
     ...
     *
     * @var \TecCom\Order\TXML5\AvaRsp\AvaRspAType\LineAType\TotalQuantityAType $totalQuantity
     */
    ...
    /**
     * Information about all delivery options for a main line.
     *
     ...
     *
     * 2. The seller **must not** add delivery options to sublines.
     *
     * @var \TecCom\Order\TXML5\DeliveryInfoType[] $deliveryOptions
     */
     ...
     *
     * 2. This also applies if the buyer has not actually sent a `DocumentNumber`. In this case the dummy value `.` must be set for `Number`.
     *
     ...
     *
     * Free text **must** be agreed between buyer and supplier, otherwise the buyer will ignore it.
     *
     ...
     * Information about the requested and confirmed quantity of the line.
     *
     * @return \TecCom\Order\TXML5\AvaRsp\AvaRspAType\LineAType\TotalQuantityAType
     */
     ...
     * Information about the requested and confirmed quantity of the line.
     *
     * @param \TecCom\Order\TXML5\AvaRsp\AvaRspAType\LineAType\TotalQuantityAType $totalQuantity
     * @return self
     */
    public function setTotalQuantity(\TecCom\Order\TXML5\AvaRsp\AvaRspAType\LineAType\TotalQuantityAType $totalQuantity)
    {
     ...
     *
     * @return self
     * @param \TecCom\Order\TXML5\DeliveryInfoType $deliveryOptions
     */
    public function addToDeliveryOptions(\TecCom\Order\TXML5\DeliveryInfoType $deliveryOptions)
    {
     ...
     * @return bool
     */
    public function issetDeliveryOptions($index)
    {
        return isset($this->deliveryOptions[$index]);
    }
     ...
     * @return void
     */
    public function unsetDeliveryOptions($index)
    {
        unset($this->deliveryOptions[$index]);
    }

    /**
     * Gets as deliveryOptions
     *
     * Information about all delivery options for a main line.
     *
     * 1. The seller **must not** add delivery options to a main line if:
     ...
     * 2. The seller **must not** add delivery options to sublines.
     *
     * @return \TecCom\Order\TXML5\DeliveryInfoType[]
     */
     ...
     * @return self
     */
    public function setDeliveryOptions(?array $deliveryOptions = null)
    {
        $this->deliveryOptions = $deliveryOptions;
        return $this;
    }
