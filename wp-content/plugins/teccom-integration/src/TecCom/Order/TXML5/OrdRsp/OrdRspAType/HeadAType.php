...
{
    /**
     * The identifier of the order response (this is **not** the seller order number).
     *
     * This **must** be unique over all order responses the seller sends (that is, no two order responses may share the same identifier).
     *
    ...
    /**
     * The specific point in time when the order response was created.
     *
    ...
    /**
     * Information about the currency of the order response.
     *
