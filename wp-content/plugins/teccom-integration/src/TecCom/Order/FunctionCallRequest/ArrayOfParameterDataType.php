...
{
    /**
     * @var \TecCom\Order\FunctionCallRequest\ParameterDataType[] $parameterData
     */
     ...
     */
    public function addToParameterData(\TecCom\Order\FunctionCallRequest\ParameterDataType $parameterData)
    {
