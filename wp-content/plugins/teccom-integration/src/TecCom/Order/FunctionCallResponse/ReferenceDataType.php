...
class ReferenceDataType
{
    ...
    /**
     * @var \TecCom\Order\FunctionCallResponse\RoutingInfoType $routingInfo
     */
     ...
     * Gets as routingInfo
     *
     * @return \TecCom\Order\FunctionCallResponse\RoutingInfoType
     */
     ...
     *
     * @param \TecCom\Order\FunctionCallResponse\RoutingInfoType $routingInfo
     * @return self
     */
    public function setRoutingInfo(?\TecCom\Order\FunctionCallResponse\RoutingInfoType $routingInfo = null)
    {
